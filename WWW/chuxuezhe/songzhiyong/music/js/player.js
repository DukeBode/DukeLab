...
class Musics {
    ...
    constructor() {
            this.songs = [{
                    ...
                    title: '明天，你好',
                    singer: '牛奶咖啡',
                    songUrl: '/static/media/0.mp3',
                    imageUrl: '/songzhiyong/music/images/songs/c.jpg'
                },
                {
                    id: 2,
                    title: '爱情转移',
                    singer: '陈奕迅',
                    songUrl: '/static/media/1.mp3',
                    imageUrl: '/songzhiyong/music/images/songs/renzhendexue.jpg'
                },
                {
                    id: 3,
                    title: '有点甜',
                    singer: '汪苏泷；By2',
                    songUrl: '/static/media/2.mp3',
                    imageUrl: '/songzhiyong/music/images/songs/yanyuan.jpg'
                },
                {
                    id: 4,
                    title: '算什么男人',
                    singer: '周杰伦',
                    songUrl: '/static/media/3.mp3',
                    imageUrl: '/songzhiyong/music/images/songs/renzhendexue.jpg'
                },
                {
                    id: 5,

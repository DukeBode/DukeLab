...
class MicroCommunity:
    ...
    def save(self, time='12', table='table0'):
        ...
        while state:
            for line in self.content():
                ...
                data = str(tuple(line_content.values()))  # .replace('\'', '')
                if line_content['createTime'][2:3] == '-' and line_content['createTime'][:2] == time \
